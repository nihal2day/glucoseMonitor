...
class DDPG:
    def __init__(self, state_size, action_space, actor_hidden_size, critic_hidden_size, replay_buffer_size, batch_size,
                 lr_actor, lr_critic, gamma, tau, sigma, theta, dt, my_init_hyp = 0, gpu='colab'):
        ...
        self.actor = Actor(self.device,self.state_size, self.actor_hidden_size, self.action_space, self.my_init_hyp)
